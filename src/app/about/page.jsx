                ...
                <div className="card-body p-4">
                  <div>
                    <div className="mb-lg-5 mb-md-4">
                      ...
                      <p className="mb-3">
                        In 2017, a small spark lit up a bold vision-to make
                        travel accessible for everyone, everywhere.This vision
                        gave life to GoZayaan, a name now synonymous with
                      ...
                      <p className="mb-3">
                        ...
                        explore the world effortlessly. Our mission is simple:
                        to make travel stress-free, transparent, and accessible.
                      ...
                      <p className="mb-3">
                        At GoZayaan, innovation and technology are at the heart
                        of what we do. Our user-friendly platform is designed to
                        simplify travel planning by offering real-time pricing,
                        exclusive deals, and customized solutions. From flights
                        and hotels to customized tours and visa services, we
                        open the door to limitless possibilities.
                      </p>
                      <p className="mb-3">
                        As one of Bangladesh's leading OTA (Online Travel
                        Agency) platforms, we are committed to redefining the
                        way you travel. We believe that dreams aren't just meant
                        to be dreamed-they're meant to be lived. Together, let's
                        make every journey a seamless story worth telling.
                      </p>
                    </div>
                    ...
                    <div className="mb-lg-5 mb-md-4">
                      ...
                      <div className="mb-3">
                        ...
                        <p>
                          6th Floor, House 168, Block B, Sayednagar Gulsan,
                    ...
                    <div>
                      ...
                      <p>
                        GoZayaan is a global enterprise, governed by the
                        Singapore Travel Agents Act 1975 and Singapore Travel
                        Agents Regulations 2017. All services are operated under
                        the laws of Singapore, ensuring compliance and
                        transparency across its platforms.
                      </p>
                    </div>
                  </div>
                </div>
